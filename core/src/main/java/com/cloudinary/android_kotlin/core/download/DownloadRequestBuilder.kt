...
//    /**
//     * Set a [ResponsiveUrl] that will be used to generate the url with.
//     * Only applies if [.load] was called with a cloudinary publicId.
//     * @return Itself for chaining
//     */
//    fun responsive(responsiveUrl: ResponsiveUrl?): DownloadRequestBuilder?
//
//    /**
//     * Set a [ResponsiveUrl.Preset] that will be used to generate the url with.
//     * Only applies if [.load] was called with a cloudinary publicId.
//     * @return Itself for chaining
//     */
//    fun responsive(responsivePreset: ResponsiveUrl.Preset?): DownloadRequestBuilder?
